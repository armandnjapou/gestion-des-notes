				...
				<div class="card card-body mb-sm-2">
					...
					<form:form action="#" method="post" commandName="cours">
						<div class="form-group">
							<form:label path="intitule">Noms du cours </form:label>
						...
						<div class="form-group">
							...
							<form:input type="text" path="nb_heure" cssClass="form-control" required="true" id="nb_heure" />
						</div>
						
						<div class="form-group">
							<form:label path="coefficient">Coefficient</form:label>
							<form:input type="text" path="coefficient" cssClass="form-control" required="true" id="coefficient" />
						</div>
