			...
			<div class="row">
				...
				<table class="table">
				  <thead class="thead-dark">
				    <tr>
				      ...
				      <c:forEach items="${listeCours}" var="lc" varStatus="boucle">
				      	<th scope="col"><a href="editNotesCours/${lc.id_cours}">${lc.intitule}</a></th>
				      </c:forEach>
				  ...
				  <tbody>
				      ...
				      <td><a href="editNotes/${en.etudiant.id_etudiant}" class="btn edit"><span class="oi oi-pencil mr-sm-2" title="Modifier" aria-hidden="true"></a>
					  </td>
				    </tr>
				  	</c:forEach>
				  </tbody>
